...
### Solución:
- **Entrando en la página vemos un pescado jugando ajedrez ajaja, lo ignoramos y nos vamos a inspeccionar la pagina.**
```bash
<!DOCTYPE html>
<html>
  <head>
    ...
    <div class="mb-2">
      <div class="chat-container d-flex align-items-start">
        <div class="profile-icon">
          <img src="img/Fish_svg_icon.svg" alt="Profile" />
        </div>
...
```
- **Estando de vuelta con el pescado intelectual, inspeccionamos la pagina, vamos a la consola y colocamos lo siguiente:**
```bash
sendMessage("eval -10000000")
undefined
```
- **Siendo la respuesta del pez:**
```
Huh???? How can I be losing this badly... I resign... here's your flag: picoCTF{c1i3nt_s1d3_w3b_s0ck3t5_a2a9bbe9}
```

> [!note] Recuerda!
> Si la consola no permite escribir o pegar, poner el 'alow pasting'.
