...
```bash
estefania@estefania-IdeaPad-3-14ALC6:~/macro$ wget https://mercury.picoctf.net/static/2e739f9e0dc9f4c1556ea6b033c3ec8e/Forensics%20is%20fun.pptm 
--2025-05-05 13:09:22--  https://mercury.picoctf.net/static/2e739f9e0dc9f4c1556ea6b033c3ec8e/Forensics%20is%20fun.pptm
...
Forensics is fun.p 100%[================>]  97,75K   217KB/s    in 0,5s    

2025-05-05 13:09:39 (217 KB/s) - ‘Forensics is fun.pptm’ saved [100093/100093]
```
- **Vemos el tipo de archivo, vemos que es un powerpoint, por lo tanto lo abrimos para ver sus macros, pero no hay nada interesante.**
```bash
estefania@estefania-IdeaPad-3-14ALC6:~/macro$ file Forensics\ is\ fun.pptm 
Forensics is fun.pptm: Microsoft PowerPoint 2007+
estefania@estefania-IdeaPad-3-14ALC6:~/macro$ open Forensics\ is\ fun.pptm 
```
- **Descomprimimos**
```bash
estefania@estefania-IdeaPad-3-14ALC6:~/macro$ unzip Forensics\ is\ fun.pptm 
...
```
- **El archivo que nos llama la atención es justamente el ultimo, por lo cual le aplicaremos un cat para leer su contenido**
```bash
estefania@estefania-IdeaPad-3-14ALC6:~/macro$ cat ppt/slideMasters/hidden
Z m x h Z z o g c G l j b 0 N U R n t E M W R f d V 9 r b j B 3 X 3 B w d H N f c l 9 6 M X A 1 f Q
```
- **Añadimos tr para eliminar los espacios y base64 para decodificar el texto.**
```bash
estefania@estefania-IdeaPad-3-14ALC6:~/macro$ cat ppt/slideMasters/hidden | tr -d ' '| base64 -d
